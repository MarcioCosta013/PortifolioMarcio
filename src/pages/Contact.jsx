...
const Contact = () => (
  <div className="container mx-auto p-9 m-11">
    <div className="bg-lightBg text-lightText dark:bg-darkBg dark:text-darkText gap-10 pt-20 min-h-screen flex flex-col items-center p-9 m-11 border-double border-4 border-darkBg dark:border-lightBg">
